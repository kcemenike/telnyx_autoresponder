...
# Mapping the content of the SMS to a response
MAPPING = {
    "pizza": "Chicago pizza is the best",
    "ice cream": "I prefer gelato"
}
# When mapped SMS content is not found, use DEFAULT
DEFAULT = "Please send either the word 'pizza' or 'ice cream' for a different response0"
